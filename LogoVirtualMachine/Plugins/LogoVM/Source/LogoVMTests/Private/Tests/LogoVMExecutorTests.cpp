...
bool FLogoVMExecutorTest_MissingCommand::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("The current command is not supported at the time!"), bExecutionResult, false);
...
bool FLogoVMExecutorTest_ForwardStringArg::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("The forward command take just a numeric value as an argument!"), bExecutionResult, false);
...
bool FLogoVMExecutorTest_ForwardOutOfBounds::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("The forward command has finished with an out of bounds!"), bExecutionResult, false);
...
bool FLogoVMExecutorTest_ForwardUp::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("The turtle's position on X axis is wrong!"), LogoVM.GetTurtlePosition().X, 7);
	TestEqual(TEXT("The turtle's position on Y axis is wrong!"), LogoVM.GetTurtlePosition().Y, 4);
...
bool FLogoVMExecutorTest_ForwardDown::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("The turtle's position on X axis is wrong!"), LogoVM.GetTurtlePosition().X, 7);
	TestEqual(TEXT("The turtle's position on Y axis is wrong!"), LogoVM.GetTurtlePosition().Y, 10);
...
bool FLogoVMExecutorTest_ForwardLeft::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("The turtle's position on X axis is wrong!"), LogoVM.GetTurtlePosition().X, 4);
	TestEqual(TEXT("The turtle's position on Y axis is wrong!"), LogoVM.GetTurtlePosition().Y, 7);
...
bool FLogoVMExecutorTest_ForwardRight::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("The turtle's position on X axis is wrong!"), LogoVM.GetTurtlePosition().X, 10);
	TestEqual(TEXT("The turtle's position on Y axis is wrong!"), LogoVM.GetTurtlePosition().Y, 7);
...
bool FLogoVMExecutorTest_BackwardStringArg::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("The backward command take just a numeric value as an argument!"), bExecutionResult, false);
...
bool FLogoVMExecutorTest_BackwardOutOfBounds::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("The backward command has finished with an out of bounds!"), bExecutionResult, false);
